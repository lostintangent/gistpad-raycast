...
This repository includes a Raycast extension which acts as a companion client to https://gistpad.dev, and the GistPad [VS Code extension](https://aka.ms/gistpad). In particular, it provides a menu bar with quick access to opening your daily note for today, and creating new gists.
